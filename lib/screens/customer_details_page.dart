...
class CustomerDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final balance =
        (customerData['currentBill'] ?? 0.0) - (customerData['paidNow'] ?? 0.0);
      ...
      builder: (context, lang, _) {
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
              _buildInfoCard('Phone', customerData['phone'], Icons.phone, null),
              _buildInfoCard(
                balanceText,
      ...
      children: [
        _buildFeatureCard(context, 'New Sale', Icons.add_shopping_cart, () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  AddCustomerPage(docId: docId, existingData: customerData),
            ),
          );
        }),
